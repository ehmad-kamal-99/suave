...
func configureAPI(api *operations.SuaveAPI) http.Handler {
	...
	if api.AddUsernameHandler == nil {
		api.AddUsernameHandler = operations.AddUsernameHandlerFunc(func(params operations.AddUsernameParams) middleware.Responder {
			return middleware.NotImplemented("operation operations.AddUsername has not yet been implemented")
		})
	}
	...
	if api.GetUsernameHandler == nil {
		api.GetUsernameHandler = operations.GetUsernameHandlerFunc(func(params operations.GetUsernameParams) middleware.Responder {
			return middleware.NotImplemented("operation operations.GetUsername has not yet been implemented")
		})
	}
